$( function () {
    var loader = {
        ...
        page: 1,
        loading: false,
        show: false, // была ли нажата кнопка load more во время загрузки данных
        total: 0,
        shown: 4,
        loadNext: function () {
            this.page++;
            ...
            $.ajax( {
                ...
                dataType: 'json',
                data: {
                    page: this.page // передаем номер страницы
                },
                success: function ( result ) {
                    ...
                    if ( loader.show ) {
                        ...
                        loader.show = false;
                        loader.loadNext(); // загружаем следующую порцию данных, но не показываем пока не нажали кнопку load more
                        // hide loader
